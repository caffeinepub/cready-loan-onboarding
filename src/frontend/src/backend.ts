...
export class Backend implements backendInterface {
    ...
    async getLoanOffers(): Promise<Array<LoanOffer>> {
        if (this.processError) {
            try {
                const result = await this.actor.getLoanOffers();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitLoanApplication(arg0: Profile, arg1: bigint): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.submitLoanApplication(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
